...
class _DashboardState extends State<Dashboard> {
    ...
    switch (index) {
      ...
      case 1:
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  const PlaceholderPage(title: "Find Page")),
        );
        break;
      case 2:
        Navigator.push(
          ...
          MaterialPageRoute(
              builder: (context) =>
                  const PlaceholderPage(title: "Add New Page")),
        );
        break;
      case 3:
      ...
      child: Column(
        ...
        children: [
              ...
              children: [
                Expanded(
                    child: _buildStatCard(
                        "Upcoming", "0", Icons.calendar_today, Colors.green)),
          ...
          const Padding(
            ...
            child: Text("Medical Specialties",
  ...
  Widget _buildSpecialtyCard(BuildContext context, String title, String subtitle,
