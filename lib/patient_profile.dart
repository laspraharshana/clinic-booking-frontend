...
import 'package:myapp/privacy_security.dart';
import 'package:myapp/payment_methods.dart';
import 'package:myapp/app_settings.dart';
import 'package:myapp/help_faq.dart';
import 'package:myapp/contact_support.dart';
import 'package:flutter/material.dart';
import 'package:myapp/Doctors_page.dart';
import 'package:myapp/visits_page.dart';
import 'package:myapp/auth_service.dart';
import 'package:myapp/SigninAndSignup.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  void _onBottomNavTapped(int index) {
    ...
    switch (index) {
      case 0:
        if (Navigator.canPop(context)) Navigator.pop(context); // Home -> back to Dashboard
        break;
      case 1:
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: isSelected
            ? BoxDecoration(color: Colors.green[50], borderRadius: BorderRadius.circular(20))
            : null,
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            ...
            if (isSelected)
              Container(
                width: 6,
                height: 6,
                decoration: const BoxDecoration(shape: BoxShape.circle, color: kPrimaryDark),
              ),
          ],
        ),
      ),
