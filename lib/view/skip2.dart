...
import 'skip3.dart'; // <-- navigate to the third screen
...
class Skip2Screen extends StatelessWidget {
  ...
  void _goToSkip3(BuildContext context) {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (_) => const Skip3Screen()),
    );
  }

  @override
  Widget build(BuildContext context) {
    const pageIndex = 1; // 0-based; this is page 2
    const pageCount = 3;
          ...
          children: [
            ...
            SingleChildScrollView(
              ...
              child: Column(
                children: const [
                  SizedBox(height: 12),
                  _HeroCircle(icon: Icons.local_hospital_rounded),
                  SizedBox(height: 26),
                  _AccentCard(icon: Icons.location_on_outlined),
                  SizedBox(height: 26),
                  _Title(),
                  SizedBox(height: 12),
                  _Description(),
            ...
            Positioned(
              ...
              child: Column(
                ...
                children: const [
                  _ContinueArea(), // button + page count
                ],
              ),
            ),
          ],
...
class _Description extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Padding(
      ...
      child: Text(
        'Select from a wide network of trusted hospitals and clinics '
        'near you for convenient healthcare.',
        textAlign: TextAlign.center,
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        const Text('2 of 3', style: TextStyle(color: Colors.black38, fontSize: 12)),
      ],
    );
  }
}
